...
* [Peking University Online Judge (POJ)](http://poj.org/problemlist)
* [The On-Line Encyclopedia of Integer Sequences](http://oeis.org/)
* [Android Reference](http://developer.android.com/reference/packages.html)
* [Java API Specification](http://docs.oracle.com/javase/6/docs/api/)
* [Markdown Syntax](http://daringfireball.net/projects/markdown/syntax)
* [Twitter API 1.1](https://dev.twitter.com/docs/api/1.1)
* [Apigee](https://apigee.com/console/)
* [Python 2.5 Reference](http://docs.python.org/reference/index.html)
